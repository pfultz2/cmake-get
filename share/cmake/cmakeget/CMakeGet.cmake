...
function(cget_find_recipe RECIPE_DIR SRC)
    ...
    set(RECIPE_PATH ${NAME})
    if(VARIANT)
        set(RECIPE_PATH ${NAME}/${VARIANT})
    endif()
    foreach(RECIPE ${ARGN})
        if(EXISTS ${RECIPE}/${RECIPE_PATH}/package.txt OR EXISTS ${RECIPE}/${RECIPE_PATH}/requirements.txt)
            # TODO: Check variant
            set(${RECIPE_DIR} ${RECIPE}/${RECIPE_PATH} PARENT_SCOPE)
            break()
        endif()
    endforeach()
endfunction()
