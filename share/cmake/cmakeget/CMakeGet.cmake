...
function(cget_find_cmake FILE DIR)
    ...
    if(EXISTS ${FILE})
        file(COPY ${FILE} ${DIR}/CMakeLists.txt)
    else()
...
function(cmake_get PKG)
    ...
    cget_install_dir(${DIR} BUILD_DIR ${TMP_DIR}/build PREFIX ${PARSE_PREFIX} CMAKE_ARGS -DCGET_CMAKE_ORIGINAL_SOURCE_FILE="${_cget_cmake_original_file}" ${PARSE_CMAKE_ARGS})
